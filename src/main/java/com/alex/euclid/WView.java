...
public class WView {
     ...
     */
    double accessX(double tx) {return ((A*tx*M)/(k0*k3)+C);}
    /**
     ...
     * @return - возвращает координаты экрана
     */
    double accessY(double ty) {return ((B*ty*M)/(k0*k3)+D);}
     ...
     */
     ...
     double revAccessX(double wx) {return ((wx-C)/A)/M*k0*k3;}
     ...
     */
      double revAccessY(double wy) {return ((wy-D)/B)/M*k0*k3;}
